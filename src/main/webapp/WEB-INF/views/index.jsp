...
<a href="${pageContext.request.contextPath}/users/order">User orders</a>
<a href="${pageContext.request.contextPath}/users/registration">Sign up!</a>
<p></p>
<a href="${pageContext.request.contextPath}/products/admin">Admin catalog</a>
<a href="${pageContext.request.contextPath}/users/order/admin">Admin orders</a>
